...
--%>
<%@ page pageEncoding="UTF-8" contentType="text/html;charset=UTF-8" import="com.xxglxt.pojo.*" language="java" %>
<%
...
<body>
    ...
    <div class="rightinfo">
        <table class="tablelist">
            ...
            <tbody>
                <% String gender = (((User)session.getAttribute("user")).getSex()).equals("1") ? "男" : "女";%>
